...
links-as-notes: true
colorlinks: true
github-repo: TeddYenn/population_genomics-edamame
cover-image: 
...
> #### Our core collection-based pipeline unveils distinctive selection patterns between vegetable and grain soybeans, identifying selection footprints and favorable alleles in vegetable soybeans, and guiding genomic insights for enhanced breeding strategies. {.unnumbered}

### 📍 **Keywords:** {.unnumbered}

> #### Vegetable soybean, population structure, diversity and differentiation, genomic scans, core collection, selection footprint. {.unnumbered}
